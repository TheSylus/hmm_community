...
export const LactoseFreeIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.083 12h3.834" />
    </svg>
);

export const VeganIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 3.75l4.5 12.75L21.75 3.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V12.75" />
    </svg>
);

export const GlutenFreeIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 9.75l-3.75 3.75m0 0a2.25 2.25 0 01-3.182 0 2.25 2.25 0 010-3.182l3.75-3.75a2.25 2.25 0 013.182 0 2.25 2.25 0 010 3.182z" />
...
export const UserGroupIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.952a4.5 4.5 0 01-9 0m9 0a4.5 4.5 0 00-9 0m9 0a4.5 4.5 0 019 0m-9 0h9m-9 0a4.5 4.5 0 019 0" />
    </svg>
);
...
export const BuildingStorefrontIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.01a.75.75 0 01.75.75v7.5m-3.75-7.5V21a.75.75 0 00.75.75h3a.75.75 0 00.75-.75V13.5m-3.75 0V12A2.25 2.25 0 0013.5 9.75h.01a2.25 2.25 0 002.25 2.25V13.5m0-3V4.875c0-.621-.504-1.125-1.125-1.125H4.125A1.125 1.125 0 003 4.875V18a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021 18V10.5M16.5 13.5v-3m0 3V21" />
    </svg>
);
...
export const ChatBubbleOvalLeftIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72A1.125 1.125 0 016.75 15H6a2.25 2.25 0 01-2.25-2.25V6.75A2.25 2.25 0 016 4.5h3.75c.969 0 1.813.713 2.097 1.511l.754 2.262c.11.33-.044.68-.342.888l-1.48.987c-.333.222-.333.722 0 .944l1.48.987c.298.208.452.558.342.888l-.754 2.262z" />
    </svg>
);

export const AllergenGlutenIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 2a10 10 0 1010 10h-2a8 8 0 11-8-8V2z" />
        <path d="M22 2L12 12" />
    </svg>
);
export const AllergenDairyIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 2a10 10 0 00-4 19.05V12h8v9.05A10 10 0 0012 2z" />
        <path d="M12 2l-1.5 4h3L12 2z" />
    </svg>
);
export const AllergenPeanutIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 10c-2.4 0-4-1.6-4-3.5S9.6 3 12 3s4 1.6 4 3.5S14.4 10 12 10z" />
        <path d="M12 10c-1.5 0-3 1-3 3v5c0 1.7 1.3 3 3 3s3-1.3 3-3v-5c0-2-1.5-3-3-3z" />
    </svg>
);
export const AllergenTreeNutIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 2a7 7 0 00-7 7c0 5 7 13 7 13s7-8 7-13a7 7 0 00-7-7z" />
        <path d="M12 9a3 3 0 100-6 3 3 0 000 6z" />
    </svg>
);
export const AllergenSoyIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M18 10c0-4.42-3.58-8-8-8S2 5.58 2 10s3.58 8 8 8 8-3.58 8-8z" />
        <path d="M12 12m-3 0a3 3 0 106 0 3 3 0 10-6 0" />
    </svg>
);
export const AllergenEggIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 22C17.5 22 22 17.5 22 12S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10z" />
        <path d="M12 8a4 4 0 100 8 4 4 0 000-8z" />
    </svg>
);
export const AllergenFishIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M2.5 10.5c0-3 2-6 5.5-6s5.5 3 5.5 6-2 6-5.5 6-5.5-3-5.5-6z" />
        <path d="M13.5 10.5c0-3 2-6 5.5-6s5.5 3 5.5 6-2 6-5.5 6" />
    </svg>
);
export const AllergenShellfishIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 2a10 10 0 00-10 10c0 4 3 7.4 7 9" />
        <path d="M12 2a10 10 0 0110 10c0 4-3 7.4-7 9" />
        <path d="M2 12h20" />
    </svg>
);
