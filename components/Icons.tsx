...
export const UserPlusIcon = createIcon(
    <>
        <path d="M12.75 4.5a3.75 3.75 0 00-7.5 0v.75h7.5v-.75z" /><path fillRule="evenodd" d="M12 7.5a1.5 1.5 0 01.75.25A5.965 5.965 0 0117.25 12v.75a.75.75 0 01-1.5 0v-.75a4.5 4.5 0 00-9 0v.75a.75.75 0 01-1.5 0v-.75A5.965 5.965 0 0111.25 7.75a1.5 1.5 0 01.75-.25z" clipRule="evenodd" />
    </>
);

export const HomeIcon = createIcon(
    <>
        <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" /><path d="M12 5.432l8.159 8.159c.026.026.05.054.07.082v.001c.02.027.04.055.059.083v.001c.02.027.038.055.056.083v.001c.018.028.036.056.052.084v.001a.75.75 0 00.09.118l.335.336a.75.75 0 00.118.09V21.75a2.25 2.25 0 01-2.25 2.25h-5.25a.75.75 0 01-.75-.75V16.5a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75v5.25a.75.75 0 01-.75.75H4.5a2.25 2.25 0 01-2.25-2.25V15.58a.75.75 0 00.09-.118l.335-.336a.75.75 0 00.118-.09V15.15c.016-.028.034-.056.052-.084v-.001c.018-.028.036-.055.056-.083v-.001c.019-.028.039-.056.059-.083v-.001c.02-.028.044-.056.07-.082L12 5.432z" />
    </>
);

export const ListBulletIcon = createIcon(<path fillRule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z" clipRule="evenodd" />);

export const Cog6ToothIcon = createIcon(<path fillRule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.542A1.237 1.237 0 016.03 6.03c-1.104 0-2.074.802-2.198 1.859a3.483 3.483 0 00-1.859 2.198c-.157.882-.663 1.699-1.542 1.85A1.237 1.237 0 012.25 12.922c0 .917.663 1.699 1.542 1.85a3.483 3.483 0 002.198 1.859c.882.157 1.699.663 1.85 1.542a1.237 1.237 0 012.252 2.252c.917 0 1.699-.663 1.85-1.542a3.483 3.483 0 001.859-2.198c.157-.882.663-1.699 1.542-1.85a1.237 1.237 0 012.252-2.252c0-.917-.663-1.699-1.542-1.85a3.483 3.483 0 00-2.198-1.859c-.882-.157-1.699-.663-1.85-1.542A1.237 1.237 0 0117.97 6.03c1.104 0 2.074-.802 2.198-1.859a3.483 3.483 0 001.859-2.198c.157-.882.663-1.699 1.542-1.85A1.237 1.237 0 0121.75 3.078c0-.917-.663-1.699-1.542-1.85A3.483 3.483 0 0018.01 -.03c-.882-.157-1.699-.663-1.85-1.542A1.237 1.237 0 0113.908 0c-.917 0-1.699.663-1.85 1.542A3.483 3.483 0 0010.2 3.738c-.882.157-1.699-.663-1.85 1.542a1.237 1.237 0 01-2.252 2.252zM12 8.25a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5z" clipRule="evenodd" />);

export const BookmarkSquareIcon = createIcon(<path fillRule="evenodd" d="M3 3a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 3v18a.75.75 0 01-1.28.53l-6.22-6.22a.75.75 0 00-1.06 0l-6.22 6.22A.75.75 0 013 21V3zm4.5 3.75a.75.75 0 01.75-.75h6a.75.75 0 010 1.5h-6a.75.75 0 01-.75-.75z" clipRule="evenodd" />);