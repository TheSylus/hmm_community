...
export const StarIcon: React.FC<ToggleIconProps> = ({ filled = false, ...props }) => (
    <svg
...
export const HeartIcon: React.FC<ToggleIconProps> = ({ filled, ...props }) => {
    if (filled) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const AllergenGlutenIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm-2 6l-2 4h8l-2-4zm0 6l2 4 2-4z" /></svg>);
export const AllergenDairyIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 4a3 3 0 013 3H9a3 3 0 013-3zm-3.5 8a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm7 0a1.5 1.5 0 110-3 1.5 1.5 0 010 3z" /></svg>);
export const AllergenPeanutIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm-2 5a2 2 0 114 0 2 2 0 01-4 0zm0 6a2 2 0 114 0v3a2 2 0 11-4 0v-3z" /></svg>);
export const AllergenTreeNutIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zM12 6l-4 6h8z" /></svg>);
export const AllergenSoyIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zM10 8a2 2 0 114 0 2 2 0 01-4 0zm-2 6h8a2 2 0 01-2 2h-4a2 2 0 01-2-2z" /></svg>);
export const AllergenEggIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 4a4 4 0 014 4c0 2.2-1.8 4-4 4s-4-1.8-4-4a4 4 0 014-4z" /></svg>);
export const AllergenFishIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 5c-3 0-5 2-5 5s2 5 5 5 5-2 5-5-2-5-5-5zm0 2a1 1 0 110 2 1 1 0 010-2z" /></svg>);
export const AllergenShellfishIcon: React.FC<IconProps> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm-4 7l4 4 4-4H8zm0 4v2h8v-2H8z" /></svg>);
