...
import { HomeIcon, GlobeAltIcon, UserGroupIcon, ListBulletIcon, Cog6ToothIcon } from './Icons';
...
export const BottomNavBar: React.FC<BottomNavBarProps> = ({ currentView, setView, onOpenSettings }) => {
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-top z-30">
            <div className="container mx-auto grid grid-cols-4">
                ...
                <button
                    ...
                    className="flex flex-col items-center justify-center pt-2 pb-1 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-200"
                >
                    <Cog6ToothIcon className="w-6 h-6 mb-1" />
                    <span className="text-xs font-medium">{t('header.button.settings')}</span>
                </button>
            </div>
            <style>{`
             .shadow-top {
