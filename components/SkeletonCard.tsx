...
export const SkeletonCard: React.FC = () => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 overflow-hidden flex flex-row h-32 sm:h-36 animate-pulse">
        {/* Left Side: Image Placeholder (Square) */}
        <div className="aspect-square h-full shrink-0 bg-gray-200 dark:bg-gray-700"></div>
