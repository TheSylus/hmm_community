...
const enTranslations = {
  ...
  "household.error.rls": "Permission Denied: Your database security rules are blocking this action. Please ensure you have a policy that allows authenticated users to insert into the 'households' table where their user ID matches the 'owner_id'.",
  "household.error.generic": "Error creating household: {message}",
  "household.error.coerce": "A data mismatch occurred while creating the household. Please try again.",
...
const deTranslations = {
  ...
  "household.error.rls": "Zugriff verweigert: Ihre Datenbanksicherheitsregeln blockieren diese Aktion. Bitte stellen Sie sicher, dass eine Richtlinie existiert, die es authentifizierten Benutzern erlaubt, Haushalte zu erstellen, bei denen ihre Benutzer-ID mit der 'owner_id' übereinstimmt.",
  "household.error.generic": "Fehler beim Erstellen des Haushalts: {message}",
  "household.error.coerce": "Beim Erstellen des Haushalts ist ein Datenkonflikt aufgetreten. Bitte versuchen Sie es erneut.",
