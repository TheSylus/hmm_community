...
const enTranslations = {
  ...
  "household.error.rls.insert": "Permission Denied: Your database security rules are preventing household creation. This is a Supabase configuration issue. **Solution:** Go to the Supabase SQL Editor and run this command: `CREATE POLICY \"Allow users to create their own household\" ON public.households FOR INSERT TO authenticated WITH CHECK (auth.uid() = owner_id);`",
...
const deTranslations = {
  ...
  "household.error.rls.insert": "Zugriff verweigert: Ihre Datenbank-Sicherheitsregeln verhindern das Erstellen eines Haushalts. Dies ist ein Konfigurationsproblem in Supabase. **Lösung:** Gehen Sie zum Supabase SQL Editor und führen Sie diesen Befehl aus: `CREATE POLICY \"Allow users to create their own household\" ON public.households FOR INSERT TO authenticated WITH CHECK (auth.uid() = owner_id);`",
